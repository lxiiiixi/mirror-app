            ...
            <View style={styles.page}>
                <View style={styles.totalCard}>
                    <Text style={styles.totalLabel}>
                        {t("account.balanceTotal", {
                            d: "USDT",
                            defaultValue: "Total Value (USDT)",
                        })}
                    </Text>
                    <View style={styles.totalRow}>
                        ...
                        >
                            ...
                            <Image
                                source={toImageSource(images.account.refresh)}
                ...
                <View style={styles.balanceCard}>
                    <View style={styles.balanceGridRow}>
                        <View style={styles.balanceItem}>
                            ...
                            <View>
                                <Text style={styles.balanceLabel}>
                                    {t("account.ent", { defaultValue: "ENT" })}
                                </Text>
                        ...
                        <View style={styles.balanceItem}>
                            <Image
                                source={toImageSource(images.account.usdtIcon)}
                                style={styles.balanceIcon}
                            />
                            <View>
                                <Text style={styles.balanceLabel}>
                    ...
                    <View style={styles.balanceGridRow}>
                        <View style={styles.balanceItem}>
                            <Image
                                source={toImageSource(images.account.todayIcon)}
                                style={styles.balanceIcon}
                            />
                            <View>
                                <Text style={styles.balanceLabel}>
                                    {t("account.ticket", { defaultValue: "Ticket" })}
                                </Text>
                        ...
                        <View style={styles.balanceItem}>
                            <Image
                                source={toImageSource(images.account.art)}
                                style={styles.balanceIcon}
                            />
                            <View>
                                <Text style={styles.balanceLabel}>
                    ...
                    {email ? (
                        <>
                            ...
                            <View style={styles.infoRow}>
                                <View style={styles.infoContent}>
                                    <Text style={styles.infoTitle}>
                                        {t("emailLogin.email", { defaultValue: "Email" })}
                                    </Text>
                ...
                <View style={styles.linkList}>
                    <Pressable
                        ...
                        onPress={() => router.push(ROUTE_PATHS.accountToken)}
                    >
                        <Text style={styles.linkButtonText}>
                            {t("account.token", { defaultValue: "Hold RWA Token" })}
                        </Text>
                        <Image
                            source={toImageSource(images.account.right)}
                    ...
                    >
                        <Text style={styles.linkButtonText}>
                            {t("account.bill", { defaultValue: "My bill" })}
                        </Text>
                        <Image
                            source={toImageSource(images.account.right)}
                            style={styles.linkArrow}
                ...
                <Pressable
                    ...
                    onPress={() => openDialog("recharge")}
                >
                    <Text style={styles.actionButtonText}>
                        {t("account.withdrawDialog.title1", {
                            defaultValue: "Recharge and withdrawal",
                        })}
                    </Text>
                </Pressable>
            </View>
