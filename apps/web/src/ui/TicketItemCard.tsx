        ...
        return (
            <div ref={ref} className={rootClassName} {...props}>
                ...
                <div className="up-day-box text-[13px]">
                    ...
                    {upDayIcon ? (
                        <img className="up-day-icon" src={upDayIcon} alt="up day" />
                    ) : null}
                </div>
                ...
                >
                    <img
                        className="ticket-item-card__img"
                ...
                <div className="ticket-item-card__content">
                    ...
                    {cardType === 1 && (
                        <div className="ticket-item-card__content-desc text-[12px]">
                            {data.presaleUserText ? (
                                <div className="btn_user">{data.presaleUserText}</div>
                            ) : null}
                            {data.priceText ? (
                                <div>
                    ...
                    {cardType === 3 && (
                        <div className="ticket-item-card__content-desc text-[12px]">
                            ...
                            {data.rateText ? (
                                <div>
                                    <span>{mergedLabels.profitLoss}</span>
                                    <span className="value text-[13px] glow-green">
                                        {data.rateText}
                                    </span>
                                </div>
                            ) : null}
